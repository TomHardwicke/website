...
The Great Library of Alexandria was founded with the lofty ambition to gather and preserve all the world's knowledge under one roof. The Ptolemies of Egypt dispatched their agents to the marketplaces of Athens, Syracuse, and Rhodes in search of valuable papyri. Ships sailing into the bustling port of Alexandria were searched and any books found on board were confiscated[^confiscated]. Eventually, a large collection of influential ancient works was amassed, covering all manner of subjects from poetry to mathematics, penned by such luminaries as Aristotle and Euripides. And then, torched by fire, jolted by earthquake, and ravaged by warfare, the Great Library crumbled into ruin, and a valuable portion of the scholarly record was lost forever[^destruction].
...
```{r scholarly-record, fig.width = 2, fig.cap = "The modern scholarly record is a rich ecosystem of research artifacts: articles, study materials, protocols, analysis code, and data."}
knitr::include_graphics('/img/scholarly-record.png')
```

The superficial view of the scholarly record as a mere collection of articles makes it easy to overlook that other research artifacts have important roles to play in the scientific endeavour. Figure \@ref(fig:open-sci-activities) depicts a number of research activities that are either facilitated by or entirely depend upon having access to one or more research artifacts[^klein]. When research artifacts are unavailable, it undermines the efficiency and credibility of the scientific endeavour by disurpting or preventing important research[^undermines]. A striking example is the [recent dire news](https://dx.doi.org/10.1126/science.aau9619) that the Reproducibility Project: Cancer Biology has found it necessary to terminate 32 of its 50 target replication attempts due to a lack of methodological information and access to materials from the original studies. 
...
```{r open-sci-activities, fig.width = 2, fig.cap = "A open scholarly record, richly populated with research artifacts, enables a number of important research activties that faciliate verification, discovery, and evidence-synthesis."}
...
The extant scientific literature consists of an enormous body of articles reporting findings and making claims, but it is rare to see the research data that substantiates them[^noDataPublished]. After articles have been published, the data files typically exist on temporary life support -- a fragile network of vines beneath the canopy tenatively binds research artifacts to published articles. Over time, and it may be a very short amount of time, this ad-hoc system starts to atrophy: hard drives fail, e-mail addresses stop functioning, colleagues who know the whereabouts of the data files move on to new employment, and before long, the [data is practically no longer retrievable](https://dx.doi.org/10.1016/j.cub.2013.11.014). Requesting data directly from authors is typically not successful[^noDataShared]. Other research artifacts suffer a similar fate. For example, in my work I have encountered a lack of access to [study protocols](https://dx.doi.org/10.31222/osf.io/fzpcy), [analysis scripts](https://dx.doi.org/10.17605/OSF.IO/39CFB), and [study materials](https://doi.org/10.1371/journal.pbio.1002456). There was no fire, or earthquake, or war to draw our attention to this state of affairs, but it could be that most of the data generated by humanity’s previous scientific ventures has now been irrecoverably lost.
